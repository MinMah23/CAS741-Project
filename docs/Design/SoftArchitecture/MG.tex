...
\item[\refstepcounter{ucnum} \uctheucnum \label{ucGoal}:] The goal of the system is to calculate the position of the cart and the angle of pendulum.
\item[\refstepcounter{ucnum} \uctheucnum \label{ucODEstructureC}:] The equation of motion of the cart can be defined using parameters defined in the input parameters module.
\item[\refstepcounter{ucnum} \uctheucnum \label{ucODEstructureP}:] The equation of motion of the pendulum can be defined using parameters defined in the input parameters module.
...
\item [\refstepcounter{mnum} \mthemnum \label{mODEC}:] The cart equation of motion ODE Module
\item [\refstepcounter{mnum} \mthemnum \label{mODEP}:] The pendulum equation of motion ODE Module
