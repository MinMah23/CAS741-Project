...
\item[\refstepcounter{ucnum} \uctheucnum \label{ucODEstructureC}:] The equation of motion of the cart and pendulum can be defined using parameters defined in the input parameters module.
...
\item [\refstepcounter{mnum} \mthemnum \label{mODEC}:] The Equation of Motion ODE Module
